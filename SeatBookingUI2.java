...
public class SeatBookingUI2 extends JFrame implements ActionListener {
    ...
    public SeatBookingUI2() {
        // --- DATA INITIALIZATION ---
        loadData(); // Initializes/loads bookings

        // --- FRAME SETUP ---
        setTitle("Seat Booking System (No Waiting List)"); 
        setSize(1000, 700);
    ...
    // ==========================================================
    // PERSISTENCE METHODS (Serialization) - CORRECTED
    // ==========================================================
    ...
    private void loadData() {
        try (ObjectInputStream in = new ObjectInputStream(new FileInputStream(DATA_FILE))) {
            ...
            System.out.println("Data loaded successfully. " + bookings.size() + " bookings restored.");
    ...
    // SELECT Button Logic (NO WAITING LIST)
    private void handleBooking() {
        ...
        if (bookings.containsKey(seatID)) {
            JOptionPane.showMessageDialog(this, "Seat " + seatID + " is already booked.", "Seat Booked", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    // No assignSeatFromWaitingList method.
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(SeatBookingUI2::new);
    }
}